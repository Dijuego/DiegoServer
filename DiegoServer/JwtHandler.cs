...
namespace DiegoServer;

    public class JwtHandler(IConfiguration configuration, UserManager<WorldUser> userManager)
    {
    public async Task<JwtSecurityToken> GetTokenAsync(WorldUser user) =>
    new(
    ...
    private async Task<List<Claim>> GetClaimsAsync(WorldUser user)
    {
